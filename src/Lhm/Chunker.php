...
class Chunker extends Command
{
    ...
    protected function execute()
    {
        ...
        $lastUpdate = 0;
        $totalRows = 0;
        while ($this->currentPosition < $this->limit || $this->currentPosition === 0) {
            $query = $this->copy($this->currentPosition, $stride);
            ...
            $newPosition = $this->getNextChunkStart($this->currentPosition, $stride);
            if ($newPosition == $this->currentPosition) {
                $msg = "Position $newPosition invalid: $this->currentPosition pos / $stride stride";
